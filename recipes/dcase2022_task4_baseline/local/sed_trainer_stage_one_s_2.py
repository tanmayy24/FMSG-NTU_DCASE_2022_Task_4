...
class SEDTask4(pl.LightningModule):
    ...
    def training_step(self, batch, batch_indx):
        ...
        indx_s_weak, indx_weak, indx_unlabelled = self.config["training"]["batch_size"]
        ...
        weak_mask[:indx_s_weak+indx_weak] = 1
        ul_mask[indx_s_weak+indx_weak:] = 1
        ...
        features, features = feature_transformation(features, **self.config["training"]["transform"])
        ...
        weak_mixup_loss = mixup_weak_class_loss
        ...
        output_mixed_u, output_mixed_u_weak = self.detect(mixedup_x, self.sed_teacher)
        
        mixup_consistency_weak_loss = self.selfsup_loss(output_mixed_u_weak, mixedup_target_weak)# / 12
        weak_mixup_loss += mixup_consistency_weak_loss*weight
        
        weak_loss = loss_weak + weak_self_sup_loss * weight + weak_mixup_loss
