...
class SEDTask4(pl.LightningModule):
    ...
    def training_step(self, batch, batch_indx):
        ...
        features_s, features_t = feature_transformation(features, **self.hparams["training"]["transform"])
        ...
        mixed_input_weak, target_a_weak, target_b_weak, lam_weak = mixup_data_sup(features_s[weak_mask], labels_weak, mixup_sup_alpha)
        ...
        mixed_input_strong, target_a_strong, target_b_strong, lam_strong = mixup_data_sup(features_s[strong_mask], labels[strong_mask], mixup_sup_alpha)
        ...
        mixedup_x, mixedup_target, mixedup_target_weak, lam = mixup_data(features_t[ul_mask], strong_preds_teacher[ul_mask].detach(), weak_preds_teacher[ul_mask].detach(), mixup_usup_alpha)
