...
from desed_task.nnet.FDY_CRNN import FDY_CRNN
from desed_task.utils.encoder import ManyHotEncoder
from desed_task.utils.schedulers import ExponentialWarmup

from local.classes_dict import classes_labels
from local.sed_generate_labels_FDY_CRNN import SEDTask4
...
def single_run(
    ...
    ##### model definition  ############
    sed_student = FDY_CRNN(**config["net"])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--conf_file",
        default="./confs/sed_generate_labels_FDY_CRNN.yaml",
